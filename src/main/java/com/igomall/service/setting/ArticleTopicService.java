 ...
 * @version 1.0
 */
public interface ArticleTopicService extends BaseService<ArticleTopic, Long> {
	 ...
	 * @return 文章标签
	 */
	List<ArticleTopic> findList(Integer count, List<Filter> filters, List<Order> orders, boolean useCache);
